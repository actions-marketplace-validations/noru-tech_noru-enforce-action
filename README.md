...
>
> `uses: noru-tech/noru-enforce-action@v0.7.5` and
> `uses: noru-tech/noru-grc-engineering/actions/enforce@v0.7.5`
...
action in the toolkit shares one version number, listed in the [changelog](https://github.com/noru-tech/noru-grc-engineering/blob/v0.7.5/CHANGELOG.md).

## Support and contributing

How enforcement fits the rest of the workflow, including the ruleset, CODEOWNERS and the derived
worklist, is in [`docs/repository-enforcement.md`](https://github.com/noru-tech/noru-grc-engineering/blob/v0.7.5/docs/repository-enforcement.md). The
...
[security policy](https://github.com/noru-tech/noru-grc-engineering/blob/v0.7.5/SECURITY.md). Open issues and pull requests there, not in the Marketplace
